      ...
      if (platform === _platform.IOS && _this.context.isWebView && _this.props.onSwipeBack) {
        ...
        if (e.startX <= 70 && !_this.state.swipingBack && _this.props.history.length > 1) {
          _this.setState({
            ...
            scrolls: _objectSpread(_objectSpread({}, _this.state.scrolls), {}, (0, _defineProperty2.default)({}, _this.state.activePanel, _this.window.pageYOffset))
          });
        }
  ...
  (0, _createClass2.default)(View, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.activePanel !== this.props.activePanel && !prevState.swipingBack && !prevState.browserSwipe) {
        ...
        this.setState({
          ...
          activePanel: null,
          animated: true,
          scrolls: _objectSpread(_objectSpread({}, prevState.scrolls), {}, (0, _defineProperty2.default)({}, prevProps.activePanel, this.window.pageYOffset)),
          isBack: isBack
        });
    ...
    value: function waitTransitionFinish(elem, eventHandler) {
      if (_supportEvents.transitionEvent.supported) {
        ...
        this.transitionFinishTimeout = setTimeout(eventHandler, this.props.platform === _platform.ANDROID ? 300 : 600);
      }
    }
  }, {
    ...
    value: function waitAnimationFinish(elem, eventHandler) {
      ...
      if (_supportEvents.animationEvent.supported) {
        ...
        this.animationFinishTimeout = setTimeout(eventHandler, this.props.platform === _platform.ANDROID ? 300 : 600);
      }
    }
  }, {
